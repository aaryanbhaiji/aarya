...
SUDO_USERS = [956395171]

AUTH_CHANNEL = -1002528498187
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/free_ka_maal01") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/free_ka_maal01") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/free_ka_maal01")                              
                ],           
            ]
      )
...
async def edit_txt(client, message: Message):
    ...
    try:
        await message.reply_document(
            ...
            caption="📥**𝗘𝗱𝗶𝘁𝗲𝗱 𝗕𝘆 ➤ @batch_buy_bot"
        )
    except Exception as e:
...
@bot.on_message(filters.command(["rockbhaiji"]))
async def upload(bot: Client, m: Message):
    ...
    credit = "️[@Bindasboy010](https://t.me/free_ka_maal01)"
    if raw_text3 == '1':
        CR = '[@Bindasboy010](https://t.me/free_ka_maal01)'
    elif raw_text3:
        try:
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    Show = f"**🍁 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗜𝗡𝗚 🍁**\n\n**📝ɴᴀᴍᴇ » ** `{name}\n\n🔗ᴛᴏᴛᴀʟ ᴜʀʟ » {len(links)}\n\n🗂️ɪɴᴅᴇx » {str(count)}/{len(links)}\n\n🌐ʀᴇᴍᴀɪɴɪɴɢ ᴜʀʟ » {remaining_links}\n\n❄ǫᴜᴀʟɪᴛʏ » {res}`\n\n**🔗ᴜʀʟ » ** `{padhai karo maa-bapu wait kar rah hai tumhare succuess ka}`\n\n🤖𝗕𝗢𝗧 𝗠𝗔𝗗𝗘 𝗕𝗬 ➤ @Batch_buy_bot\n\n🙂 चलो फिर से अजनबी बन जायें 🙂"
